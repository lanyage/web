	...
	getPlans : function(){
		$.ajax({
            ...
            success : function (data) {
            	...
            	var item;
				$('#splan-selectable').append("<li class='ui-widget-content ui-selectee ui-selected'><img src='/resources/commons/images/map/icon_area.png' style='width:16px; height:16px'/> 全部</li>");
