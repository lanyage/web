...
var History = {
	...
	init : function(){
        ...
        html +=	'	<li id="tab_0" class="tabSelect-default" onmouseover="History.tabOver(0)" onmouseout="History.tabOut(0)">';
        html +=	'		<a href="javascript:History.tabSelect(0)"><img src=""/> '+$.rtls.history.tab.zone+' </a>';
        html +=	'	</li>';  
        html +=	'	<li id="tab_1" class="tabSelect-default" onmouseover="History.tabOver(1)" onmouseout="History.tabOut(1)">';
        html +=	'		<a href="javascript:History.tabSelect(1)"><img src=""/> '+$.rtls.history.tab.plan+' </a>';
        html +=	'	</li>';
        html +=	'</ul>';
        $('#tab').html(html);
        ...
        html +=	'    	<button id="but-export">导出</button>';
        html +=	'	</p>';
        html +=	'	</div>';
        html +=	'	</td>';
        html +=	'</tr>';
		...
		$("#but-export").click(function() {
			History.getZoneExcel();	
	...
	getZoneExcel : function(){
		...
		$.ajax({
			async : false,
			type: 'get',
			url: "/service/history.json?action=get.history.zone.excel",
			contentType: "application/json; charset=utf-8",
            dataType: 'json',
            data : { 
            	"startNum" : History.$startNum,
		...
		$.ajax({
            ...
            success : function (data) {
				...
				for(var i=0; i < data.historys.length ; i++){
            		...
            		html_count += "<li class='ui-widget-content' id='count"+item.planId+"'><img src='/resources/commons/images/tree/dir.gif'  style='float:left; padding-right:3px'/><b>"+item.planName+"</b> : "+item.count+"</li>";
