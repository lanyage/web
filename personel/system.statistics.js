var System = {
	...
	init : function(){
        ...
        html +=	'	<li id="tab_0" class="ui-state-default ui-corner-top" onmouseover="System.tabOver(0)" onmouseout="System.tabOut(0)">';
        html +=	'		<a href="javascript:System.tabSelect(0)"><img src="/resources/commons/images/tree/dir.gif"/> '+$.rtls.system.tab.day+' </a>';
        html +=	'	</li>';  
        html +=	'	<li id="tab_1" class="ui-state-default ui-corner-top" onmouseover="System.tabOver(1)" onmouseout="System.tabOut(1)">';
        html +=	'		<a href="javascript:System.tabSelect(1)"><img src="/resources/commons/images/tree/dir.gif"/> '+$.rtls.system.tab.month+' </a>';
        html +=	'	</li>';
        html +=	'	<li id="tab_2" class="ui-state-default ui-corner-top" onmouseover="System.tabOver(2)" onmouseout="System.tabOut(2)">';
        html +=	'		<a href="javascript:System.tabSelect(2)"><img src="/resources/commons/images/tree/dir.gif"/> '+$.rtls.system.tab.year+' </a>';
        html +=	'	</li>';              
        html +=	'</ul>';
        $('#tab').html(html);
		this.tabSelect(0);
