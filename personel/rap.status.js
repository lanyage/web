		...
		$.ajax({
            ...
            success : function (data) {
            	...
            	for(var i=0; i < Rap.$plans.length; i++){
					...
					"<a href=\"javascript:Rap.tabSelect("+i+")\"><img src='/resources/commons/images/tree/dir.gif'/> "+item.name+"</a>" +
					"</li>";
            ...
            success : function (data) {
            	...
            	if(Rap.$items.length == 0){
    				...
    				for(var i=0; i < Rap.$items.length; i++){
    					...
    					if(item.status == 'alive'){
    						if(item.rcmMode == '1'){
        						html += "<p><img src='/resources/commons/images/icon/icon_dot_green.gif' border='0'/>UWB 状态 : <span style='color:blue'>"+$.rtls.device.status.normal+"</span></p>";
        					}else{
        						if(item.masterStatus == '0'){
            						html += "<p><img src='/resources/commons/images/icon/icon_dot_green.gif' border='0'/>UWB 状态 : <span style='color:red'>"+$.rtls.device.status.fault+"</span></p>";
            					}else{
            						html += "<p><img src='/resources/commons/images/icon/icon_dot_green.gif' border='0'/>UWB 状态 : <span style='color:blue'>"+$.rtls.device.status.normal+"</span></p>";
            					}
        					}	
    					}else{
    						html += "<p><img src='/resources/commons/images/icon/icon_dot_green.gif' border='0'/>UWB 状态 : --</p>";
    					}
    					if(item.rcmMode == '1'){
    						html += "<p><img src='/resources/commons/images/icon/icon_dot_green.gif' border='0'/>无线同步 : --</p>";
    					}else{
    						html += "<p><img src='/resources/commons/images/icon/icon_dot_green.gif' border='0'/>无线同步 : "+item.wirelessSync+"%</p>";	
    					}
