	...
	getPlans : function(){
		$.ajax({
            ...
            success : function (data) {
            	...
            	var item;
				$('#splan-selectable').append("<li class='ui-widget-content ui-selectee ui-selected'><i id='all' class='icon-list-ul'></i> "+$.rtls.service.form.full+"</li>");
...
//			        parent.Service.resizeIframeHeight(newheight+50);
					...
					parent.Service.resizeIframeHeight(newheight+100); //黑色透明背景的高度是table的高度加上search-form的高度
				}
			}
		});
